...
data1 = [("", "Karania Arnasati", 95, 81, 100, 92, 88),
        ("", "Meyriska Anggita Putri", 100, 100, 100, 100, 99),
        ("", "Shintia Ramadhani", 98, 100, 86, 78, 90),
        ("", "Syifa Rizqya Mulyana", 95, 88, 79, 91, 100),
        ("", "Na Jaemin", 94, 95, 96, 97, 98),
        ("", "Lee Jeno", 99, 100, 100, 100, 100),
        ("", "Park Jisung", 82, 94, 87, 85, 77),
        ("", "Sheryl Callista", 93, 97, 89, 90, 100),
        ("", "Mona Sribuna", 81, 85, 83, 90, 87),
        ("", "Mark Lee", 91, 93, 100, 88, 90)
       ]
